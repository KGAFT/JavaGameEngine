...
void main() {
    ...
    FragColor = texture(normalMap, UvsCoords);//vec4(PBR(albedo, startFresnelSchlick, worldViewVector, halfWay, normals, normalize(light.position), light.color.rgb, light.color.a, metallic), light.color.a);
}
