...
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.DescriptorPool;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.DescriptorSet;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.GraphicsPipeline;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.IndexBuffer;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.PushConstant;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.ShaderMeshInputStruct;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.Texture;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.UniformBuffer;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.VertexBuffer;
import com.kgaft.VulkanRenderer.VulkanContext.GraphicsPipeline.PipelineConfiguration.PipelineConfigStruct;
...
public class VulkanRenderContext {
    ...
    private void renderFrame(int currentImage) {
        ...
        VkCommandBuffer commandBuffer = graphicsPipeline.getCommandBuffers().get(currentImage);
        VK13.vkResetCommandBuffer(commandBuffer, 0);
        ...
        uniformBuffer.writeToBuffer(currentImage, Float.SIZE, 2.0f);
        uniformBuffer.attach(commandBuffer, currentImage, pipelineConfigStruct.pipelineLayout);
        texture.attach(commandBuffer, currentImage, pipelineConfigStruct.pipelineLayout);
    ...
    private void prepareData() {
        ...
        inputData.add(
                new ShaderMeshInputStruct(new Vector3f(-0.5f, -0.5f, 0.0f), new Vector3f(0, 0, 0),
        ...
        inputData.add(new ShaderMeshInputStruct(new Vector3f(-0.5f, 0.5f, 0.0f), new Vector3f(0, 0, 0),
