...
public class GBuffer implements IFrameBuffer, WindowResizeCallBack{
    ...
    private void create(){
        ...
        GL33.glBindFramebuffer(GL33.GL_FRAMEBUFFER, id);
        positionsTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT0, null, false);
        normalTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT1, null, false);
        albedoTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT2, null, false);
        metallicTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT3, null, false);
        roughnessTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT4, null, false);
        aoTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT5, null, false);
        emissiveTexture = FrameBufferTexture.createTexture(id, width, height, GL33.GL_COLOR_ATTACHMENT6, null, false);
